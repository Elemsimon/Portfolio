  ...
  return (
    ...
    <div className="w-full">
      <p className='relative z-20 text-sm md:text-lg leading-[1.6] text-white font-normal text-wrap'>
        Hi, I&apos;m Simon Elem, a frontend developer with a passion for crafting engaging and efficient web experiences. My journey into tech began during my university days, where I found myself gravitating towards the ICT office. It was there that I discovered the thrill of problem-solving and innovation. Whether it was updating student details on the portal, contributing to campus-wide internet coverage, or making critical updates to the system, I was always eager to lend a hand and learn something new. <br />
        My curiosity didn&apos;t stop there. I ventured into the world of blogging, choosing WordPress as my canvas. This exploration led me to uncover the building blocks of web development. HTML, CSS, and JavaScript soon became my new playground. Seeking to deepen my knowledge, I secured an internship at Afrihub, where I immersed myself in the art of web development. <br />
        After graduating, I continued to hone my skills and decided to specialize in frontend development, with a particular focus on React. I embarked on various projects, including Furnushop, which is a testament to my growing expertise and creativity.<br />
        One of the most rewarding experiences was being approached by the CEO of MacSamuel Foundation to build their brand. Capturing their vision and translating it into a compelling online presence was a challenge I embraced wholeheartedly. This success opened doors to new opportunities, including developing a meths tutorial website for another client, perfectly tailored to their needs.<br />
        My journey didn&apos;t stop there. I joined Utility, where I played a crucial role in the development and testing of their app. Identifying errors and providing actionable recommendations, I contributed to creating a smoother and more reliable user experience.<br />
